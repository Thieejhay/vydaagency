...
const Footer = () => {
  return (
    <div className='flex md:flex-row flex-col w-screen lg:pt-12 p-6 lg:pb-10 pb-8 lg:pl-52 pl-8 lg:gap-32 gap-4 bg-[#e5d2c4]/30 relative'>
        ...
        <div className='flex flex-col gap-6'>
            ...
            <div className='flex gap-3'>
                <a href='https://www.facebook.com/profile.php?id=61550311576022' rel='noreferrer'><img src={Icon} alt="" className=''/></a>
