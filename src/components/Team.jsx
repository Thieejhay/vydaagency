...
const Team = () => {
  return (
    <div className='flex flex-col w-screen lg:h-screen pb-3' id='team'>
            ...
            <div className='flex relative basis-1/2 h-full'>
                ...
                <div className='flex flex-col lg:gap-3 gap-1 text-[#ffffff] absolute lg:top-20 top-2 lg:left-52 left-16'>
                    ...
                    <div className='flex flex-col'>
                        <span className='lg:text-3xl text-xl font-gilroy lg:font-gilroyy'>Meet with our</span>
        ...
        <div className='flex lg:flex-row flex-wrap lg:gap-4 gap-2 justify-center items-center lg:-mt-52 -mt-[78rem]'>
